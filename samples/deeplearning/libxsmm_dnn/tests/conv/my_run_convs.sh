...
${NUMACTL} ./layer_example ${ITERS}  224 224 ${MB}     3   64 7 7 3 3 2 ${TYPE} L ${PAD} ${FUSE}     1    8  ${PREC_BF16}
${NUMACTL} ./layer_example ${ITERS}  224 224 ${MB}     3   64 7 7 3 3 2 ${TYPE} L ${PAD} ${FUSE}     1    16 ${PREC_BF16}
${NUMACTL} ./layer_example ${ITERS}  224 224 ${MB}     3   64 7 7 3 3 2 ${TYPE} L ${PAD} ${FUSE}     1    32 ${PREC_BF16}
${NUMACTL} ./layer_example ${ITERS}  224 224 ${MB}     3   64 7 7 3 3 2 ${TYPE} L ${PAD} ${FUSE}     1    64 ${PREC_BF16}
${NUMACTL} ./layer_example ${ITERS}  224 224 ${MB}     3   64 7 7 3 3 2 ${TYPE} L ${PAD} ${FUSE}     3    1  ${PREC_BF16}
${NUMACTL} ./layer_example ${ITERS}  224 224 ${MB}     3   64 7 7 3 3 2 ${TYPE} L ${PAD} ${FUSE}     3    2  ${PREC_BF16}
${NUMACTL} ./layer_example ${ITERS}  224 224 ${MB}     3   64 7 7 3 3 2 ${TYPE} L ${PAD} ${FUSE}     3    4  ${PREC_BF16}
${NUMACTL} ./layer_example ${ITERS}  224 224 ${MB}     3   64 7 7 3 3 2 ${TYPE} L ${PAD} ${FUSE}     3    8  ${PREC_BF16}
